...
If you're unfamilar with Archipelago, I would recommend following the [Archipelago Setup Guide](https://archipelago.gg/tutorial/Archipelago/setup_en). Once you have that handled, follow the rest of these instructions:
...
1. Launch the Baba Is You client from the Archipelago Launcher. It's recommended that you do this BEFORE opening Baba Is You.
